...
--
-- Host: localhost
-- Generation Time: Feb 09, 2014 at 06:35 AM
...
--
-- Table structure for table `lectmaterial`
--

CREATE TABLE IF NOT EXISTS `lectmaterial` (
...
--
-- Dumping data for table `lectmaterial`
--
...
--
-- Table structure for table `maintopic`
--

CREATE TABLE IF NOT EXISTS `maintopic` (
  `topic_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `topic_no` tinyint(4) NOT NULL,
  PRIMARY KEY (`topic_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Dumping data for table `maintopic`
--
...
CREATE TABLE IF NOT EXISTS `subtopic` (
  ...
  `topic_id` int(10) unsigned NOT NULL,
  `title` varchar(100) NOT NULL,
  `subtopic_no` tinyint(4) NOT NULL,
...
--
-- Constraints for table `lectmaterial`
--
ALTER TABLE `lectmaterial`
  ADD CONSTRAINT `lectmaterial_ibfk_1` FOREIGN KEY (`topic_id`) REFERENCES `subtopic` (`subtopic_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `lectmaterial_ibfk_2` FOREIGN KEY (`topic_id`) REFERENCES `maintopic` (`topic_id`) ON UPDATE CASCADE;
...
ALTER TABLE `subtopic`
  ADD CONSTRAINT `subtopic_ibfk_1` FOREIGN KEY (`topic_id`) REFERENCES `maintopic` (`topic_id`) ON UPDATE CASCADE;
