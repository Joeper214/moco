	...
	echo "<span id='xbutton'>
	  ...
	  if($quiz['test_type']==1){
	    ...
	    echo "<form id='".$quiz['test_id']."' 
	      ...
	      echo "<a href='../../instructor_module/pages/stud_results.php?tid={$quiz[test_id]}' 
  ...
  public function showIdenItem($item){
      echo "<div class='panel-heading'>
             ...
             <div class='panel-body'>
               <input type='hidden' id='test_id' name='test_id' value='$test_id'>
               <input type='hidden' id='item_id' name='item_id' value='{$item['item_id']}'>
               <input type='hidden' id='iden_item_id' name='iden_item_id' value='{$item['tf_id']}'>
               <input type='hidden' id='target' name='target' value='item_mtf'>
