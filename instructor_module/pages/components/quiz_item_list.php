    ...
    <div id='sub-content'>
     <!----add item form--->     
      ...
      <div style='position: relative; top: 30px;'>
       ...
       <?php include "../pages/components/mp_item_form.php";?>
       <?php include "../pages/components/tf_item.php";?>
       <?php include "../pages/components/mtf_item.php";?>
       <?php include "../pages/components/ident_item.php";?>
      </div>
